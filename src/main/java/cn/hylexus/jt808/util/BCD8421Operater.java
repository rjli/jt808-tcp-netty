...
public class BCD8421Operater {
	...
	public static void main(String[] args) {
		System.out.println("52 二进制：" + Integer.toBinaryString(52));
		System.out.println("100 二进制：" + Integer.toBinaryString(100));
		System.out.println(52 & 100);
		
		System.out.println(Integer.toBinaryString(10));
		
		System.out.println(Double.doubleToLongBits(0.125d));
	}
}
